  ...
  const accentClasses =
    accent === "cyan"
      ? {
          ...
          arrow: "group-hover:bg-cyan-500 group-hover:text-white",
        }
      : {
          border: "border-l-purple-500",
          iconBg: "bg-purple-50 dark:bg-purple-950/40",
          icon: "text-purple-600 dark:text-purple-400",
          arrow: "group-hover:bg-purple-500 group-hover:text-white",
        };
            ...
            return (
              ...
              >
                ...
                {index < steps.length - 1 && (
                  <ArrowRight
                    size={14}
                    className="mx-2 shrink-0 text-gray-300 dark:text-gray-600"
                  />
                )}
              </div>
            );
      ...
      <div className="mt-5 flex items-center gap-2">
        ...
        <div
          className={`
            ...
            rounded-full bg-gray-50 text-gray-400
...
const WorkflowProcess = () => {
  ...
  const handleCreateProcess = () => {
    ...
    // TODO:
    // Call your create workflow API here.
    console.log({
      ...
      <div className="mx-auto">
        ...
        <div className="mb-6 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              Select a workflow process to manage its stages.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
          <WorkflowCard
            ...
            description="Asset procurement and approval workflow"
            accent="cyan"
            steps={[
              {
                label: "Raise Request",
                details: "Create asset purchase request",
                icon: FileText,
              },
              {
                label: "Quotes & Rating",
                details: "Collect and rate quotations",
                icon: Star,
              },
              {
                label: "Approve Request",
                details: "Review and approve request",
                icon: CheckCircle2,
              },
            ]}
            onClick={() =>
              navigate("/workflow-process/asset-purchase")
            }
          />
          ...
          <WorkflowCard
            ...
            steps={[
              ...
              {
                label: "Editor",
                details: "Edit and refine content",
                icon: Pencil,
              },
              {
                label: "Reviewer",
            ...
            onClick={() =>
              navigate("/workflow-process/writing")
            }
          />
        </div>
      </div>
          ...
          >
            ...
            >
              <div>
                ...
                <p className="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  Create a process and define its workflow stages.
                </p>
              </div>
                ...
                <div className="mb-3 flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-0.5 text-[11px] text-gray-500 dark:text-gray-400">
                      Add the stages in the order they should run.
                    </p>
                  </div>
            ...
            >
              ...
              <button
                ...
                disabled={
                  !processType.trim() ||
                  stages.every((item) => !item.stage.trim())
                }
                className="
